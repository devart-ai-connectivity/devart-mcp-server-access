// --------------------------------------------------------------------------
// <copyright file="OdbcAccessPrimaryKeysTool.cs" company="Devart">
//
...
{
  internal sealed class OdbcAccessPrimaryKeysTool(McpConfiguration serverConfiguration) : PrimaryKeysTool(serverConfiguration)
  {
