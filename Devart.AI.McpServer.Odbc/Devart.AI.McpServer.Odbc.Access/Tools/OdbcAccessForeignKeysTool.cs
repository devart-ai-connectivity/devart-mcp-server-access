// --------------------------------------------------------------------------
// <copyright file="OdbcAccessForeignKeysTool.cs" company="Devart">
//
...
namespace Devart.AI.McpServer.Odbc.Access.Tools
{
  internal sealed class OdbcAccessForeignKeysTool(McpConfiguration serverConfiguration) : ForeignKeysTool(serverConfiguration)
  {
      ...
      CancellationToken cancellationToken)
    {
      ...
      await using var reader = await database.ExecuteReaderAsync(
        connection,
        $"PRAGMA main.foreign_key_list([{tableName}])",
        null,
        cancellationToken
